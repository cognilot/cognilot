        ...
        <div className="p-6 md:p-8 space-y-8">
          <div>
            ...
            <p className="text-white/60 leading-relaxed max-w-2xl">
              ...
              configurado en la extensión, manteniendo completa privacidad y fricción casi nula.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 pt-4 border-t border-white/5">
            ...
            >
              <span className="text-brand-primary font-bold">{'>'}</span> ./edit_memory.sh
            </button>
            <button
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-6">
        <div className="bg-surface/90 border border-white/10 rounded-xl p-6 hover:border-white/20 transition-colors">
          <div className="text-white/20 select-none mb-3">
            <span className="text-brand-secondary">##</span> ANALYTICS
          </div>
        ...
        <div className="bg-surface/90 border border-white/10 rounded-xl p-6 hover:border-brand-primary/30 transition-colors group">
          <div className="text-white/20 select-none mb-3 group-hover:text-brand-primary transition-colors">
            <span className="text-brand-primary">##</span> UNLOCK_PRO
          </div>
          <p className="text-ghost text-[12px] leading-relaxed">
